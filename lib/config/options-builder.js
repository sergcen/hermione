...
const assertNonNegativeIntegerOrInfinity = utils.assertNonNegativeIntegerOrInfinity;
...
module.exports = (defaultFactory) => {
    ...
    function nonNegativeIntegerOrInfinity(name) {
        return option({
            parseEnv: Number,
            parseCli: Number,
            defaultValue: defaultFactory(name),
            validate: (value) => assertNonNegativeIntegerOrInfinity(value, name)
        });
    }
