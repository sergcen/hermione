...
exports.assertNonNegativeIntegerOrInfinity = (value, name) => {
    if (!isNonNegativeInteger(value) && value !== Infinity) {
        throw new Error(`"${name}" must be a non-negative integer or Infinity`);
    }
};
